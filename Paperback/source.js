...
var _Sources = (() => {
  ...
  var Paperback_exports = {};
  __export(Paperback_exports, {
    KomgaRequestInterceptor: () => KomgaRequestInterceptor,
    Paperback: () => Paperback,
    PaperbackInfo: () => PaperbackInfo,
    capitalize: () => capitalize,
    parseMangaStatus: () => parseMangaStatus
  });
  var import_types = __toESM(require_lib());

  // src/Paperback/Languages.ts
  var parseLangCode = (code) => {
    return code.toUpperCase();
  };

  // src/Paperback/Common.ts
  ...
  var Paperback = class extends import_types.Source {
    constructor() {
      super(...arguments);
  ...
  return __toCommonJS(Paperback_exports);
})();
